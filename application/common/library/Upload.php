...
use app\common\utils\oss\AliOssService;
use fast\Random;
...
class Upload
{
    ...
    public function __construct($file = null, $remote = false)
    {
    ...
    public function upload($savekey = null)
    {
        ...
        if ($this->remote) {
            AliOssService::ossUpload($object, $this->file->getPathname());
            $this->file->setSaveName($fileName);
        } else {
