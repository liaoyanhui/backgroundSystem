    ...
    var Controller = {
        index: function () {
            ...
            status1Table.api.init({
                extend: {
                    index_url: 'finance/supplier_sub_order/index/ids/1' + location.search,
                    add_url: 'finance/supplier_sub_order/add',
                    edit_url: 'finance/supplier_sub_order/edit',
                    del_url: 'finance/supplier_sub_order/del',
                    multi_url: 'finance/supplier_sub_order/multi',
                    import_url: 'finance/supplier_sub_order/import',
                    table: 'sub1_order',
                }
            });
            status2Table.api.init({
                extend: {
                    index_url: 'finance/supplier_sub_order/index/ids/2' + location.search,
                    table: 'sub2_order',
                }
            });
            status3Table.api.init({
                extend: {
                    index_url: 'finance/supplier_sub_order/index/ids/3' + location.search,
                    add_url: 'finance/supplier_sub_order/add',
                    edit_url: 'finance/supplier_sub_order/edit',
                    del_url: 'finance/supplier_sub_order/del',
                    multi_url: 'finance/supplier_sub_order/multi',
            ...
            status4Table.api.init({
                extend: {
                    index_url: 'finance/supplier_sub_order/index/ids/4' + location.search,
                    table: 'sub4_order',
                }
            });
            status5Table.api.init({
                extend: {
                    index_url: 'finance/supplier_sub_order/index/ids/5' + location.search,
                    table: 'sub5_order',
                }
            });
            //绑定事件
        ...
        table: {
            first: () => {
                ...
                table.bootstrapTable({
                    url: 'finance/supplier_sub_order/index/ids/1' + location.search,
                    pk: 'id',
                    sortName: 'id',
                    fixedColumns: true,
                    toolbar: '#toolbar1',
                    ...
                    columns: [
                        [
                            ...
                            { field: 'from_name', title: '业务公司', operate: 'BETWEEN', cellStyle: { css: { 'white-space': 'nowrap' } } },
                            { field: 'to_name', title: '供应商', operate: 'BETWEEN', cellStyle: { css: { 'white-space': 'nowrap' } } },
                            ...
                            { field: 'settlement_finished_amount', title: '已结算金额', cellStyle: { css: { 'white-space': 'nowrap' } }, formatter: (e) => Number(e).toFixed(2) },
                            { field: 'settlement_last_at', title: '结算时间', cellStyle: { css: { 'white-space': 'nowrap' } } },
            ...
            second: () => {
                ...
                // 初始化表格
                table.bootstrapTable({
                    url: 'finance/supplier_sub_order/index/ids/2' + location.search,
                    pk: 'id',
                    sortName: 'id',
                    fixedColumns: true,
                    toolbar: '#toolbar2',
            ...
            three: () => {
                ...
                // 初始化表格
                table.bootstrapTable({
                    url: 'finance/supplier_sub_order/index/ids/3' + location.search,
                    pk: 'id',
                    sortName: 'id',
                    fixedColumns: true,
                    toolbar: '#toolbar3',
            ...
            four: () => {
                ...
                // 初始化表格
                table.bootstrapTable({
                    url: 'finance/supplier_sub_order/index/ids/4' + location.search,
                    pk: 'id',
                    sortName: 'id',
                    fixedColumns: true,
                    toolbar: '#toolbar4',
            ...
            five: () => {
                ...
                // 初始化表格
                table.bootstrapTable({
                    url: 'finance/supplier_sub_order/index/ids/5' + location.search,
                    pk: 'id',
                    sortName: 'id',
                    fixedColumns: true,
                    toolbar: '#toolbar5',
