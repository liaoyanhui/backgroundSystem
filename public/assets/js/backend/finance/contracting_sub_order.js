    ...
    var Controller = {
        index: function () {
            ...
            status1Table.api.init({
                extend: {
                    index_url: 'finance/contracting_sub_order/index/ids/1' + location.search,
                    add_url: 'finance/contracting_sub_order/add',
                    edit_url: 'finance/contracting_sub_order/edit',
                    del_url: 'finance/contracting_sub_order/del',
                    multi_url: 'finance/contracting_sub_order/multi',
                    import_url: 'finance/contracting_sub_order/import',
                    table: 'sub1_order',
                }
            });
            status2Table.api.init({
                extend: {
                    index_url: 'finance/contracting_sub_order/index/ids/2' + location.search,
                    table: 'sub2_order',
                }
            });
            status3Table.api.init({
                extend: {
                    index_url: 'finance/contracting_sub_order/index/ids/3' + location.search,
                    add_url: 'finance/contracting_sub_order/add',
                    edit_url: 'finance/contracting_sub_order/edit',
                    del_url: 'finance/contracting_sub_order/del',
                    multi_url: 'finance/contracting_sub_order/multi',
            ...
            status4Table.api.init({
                extend: {
                    index_url: 'finance/contracting_sub_order/index/ids/4' + location.search,
                    table: 'sub4_order',
                }
            });
            status5Table.api.init({
                extend: {
                    index_url: 'finance/contracting_sub_order/index/ids/5' + location.search,
                    table: 'sub5_order',
                }
            });
            //绑定事件
        ...
        table: {
            first: () => {
                ...
                table.bootstrapTable({
                    url: 'finance/contracting_sub_order/index/ids/1' + location.search,
                    pk: 'id',
                    sortName: 'id',
                    fixedColumns: true,
                    toolbar: '#toolbar1',
                    ...
                    columns: [
                        [
                            ...
                            { field: 'to_name', title: '签约公司', operate: 'BETWEEN', cellStyle: { css: { 'white-space': 'nowrap' } } },
                            ...
                            { field: 'business_company_name', title: '业务公司', operate: 'LIKE', cellStyle: { css: { 'white-space': 'nowrap' } } },
                            { field: 'settlement_type2', title: '结算方式', operate: 'LIKE', formatter: (e) => getSettlementType(e), cellStyle: { css: { 'white-space': 'nowrap' } } },
            ...
            second: () => {
                ...
                // 初始化表格
                table.bootstrapTable({
                    url: 'finance/contracting_sub_order/index/ids/2' + location.search,
                    pk: 'id',
                    sortName: 'id',
                    fixedColumns: true,
                    toolbar: '#toolbar2',
            ...
            three: () => {
                ...
                // 初始化表格
                table.bootstrapTable({
                    url: 'finance/contracting_sub_order/index/ids/3' + location.search,
                    pk: 'id',
                    sortName: 'id',
                    fixedColumns: true,
                    toolbar: '#toolbar3',
            ...
            four: () => {
                ...
                // 初始化表格
                table.bootstrapTable({
                    url: 'finance/contracting_sub_order/index/ids/4' + location.search,
                    pk: 'id',
                    sortName: 'id',
                    fixedColumns: true,
                    toolbar: '#toolbar4',
            ...
            five: () => {
                ...
                // 初始化表格
                table.bootstrapTable({
                    url: 'finance/contracting_sub_order/index/ids/5' + location.search,
                    pk: 'id',
                    sortName: 'id',
                    fixedColumns: true,
                    toolbar: '#toolbar5',
